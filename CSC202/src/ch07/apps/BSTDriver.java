...
public class BSTDriver {
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("\nTrying iterator should see nothing:"); for (String x:
		 * test) System.out.println(x); System.out.println("Finished trying iterator.");
		 */
		...
		/*
		 * System.out.println("\nTrying iterator should see alpha:"); for (String x:
		 * test) System.out.println(x); System.out.println("Finished trying iterator.");
		 */
...
//    test = new BinarySearchTree<String>(comp);
		...
		/*
		 * System.out.println("\nTrying iterator should see alpha beta:"); for (String
		 * x: test) System.out.println(x);
