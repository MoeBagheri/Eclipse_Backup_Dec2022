...
public class SortedABListDriver {
	public static void main(String[] args) {
		...
		try {
			test.add(0, "alpha");
		} catch (UnsupportedOperationException eob) {
...
//    test = new SortedABList<String>(2);
		...
		/*
		 * System.out.println("\n\nTesting indexing:"); test.add(1, "One"); test.add(5,
		 * "Five"); for (String x: test) System.out.println(x);
		 * 
		 * System.out.println("\n\nRemove 0"); test.remove(0); for (String x: test)
		 * System.out.println(x);
		 * 
		 * System.out.println("\n\nRemove 4"); test.remove(4); for (String x: test)
		 * System.out.println(x);
		 * 
		 * System.out.println("\n\nSet 3"); test.set(3,"Three"); for (String x: test)
		 * System.out.println(x);
		 * 
		 * System.out.println(test.get(3)); System.out.println(test.indexOf("Three"));
...
//    test = new SortedABList<String>(15);
		...
		/*
		 * System.out.println("\n\nTrying iterator:"); for (String x: test)
		 * System.out.println(x);
		 * 
		 * test = new SortedABList<String>(15);
		 * System.out.println("\n\nTesting Iterator remove each separately"); result =
		 * test.add("1"); result = test.add("2"); result = test.add("3"); result =
		 * test.add("4");
		 * 
		 * System.out.println("\n\nTrying iterator 2:"); iter = test.iterator(); while
		 * (iter.hasNext()) { hold = iter.next(); System.out.println(hold); if
		 * (hold.equals("2")) iter.remove(); }
		 * 
		 * System.out.println("\n\nTrying iterator:"); for (String x: test)
		 * System.out.println(x);
		 * 
		 ...
		 * test.add("4");
		 * 
		 * System.out.println("\n\nTrying iterator 3:"); iter = test.iterator(); while
		 * (iter.hasNext()) { hold = iter.next(); System.out.println(hold); if
		 * (hold.equals("3")) iter.remove(); }
		 * 
		 * System.out.println("\n\nTrying iterator:"); for (String x: test)
		 * System.out.println(x);
		 * 
		 ...
		 * test.add("4");
		 * 
		 * System.out.println("\n\nTrying iterator 4:"); iter = test.iterator(); while
		 * (iter.hasNext()) { hold = iter.next(); System.out.println(hold); if
		 * (hold.equals("4")) iter.remove(); }
		 * 
		 * System.out.println("\n\nTrying iterator:"); for (String x: test)
		 * System.out.println(x);
		 * 
