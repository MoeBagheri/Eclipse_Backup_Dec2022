...
// Question 1: will ALL rewrites be occuring in BinarySearchTree.java?
// Question 2: there is no function called "add".  there is a recAdd. 
//    how exactly should this be modified?  where is it "discussed in length"?  
//    what is "recFind?"  is this in the textbook?  What does it do?
//    What methods are "related to add", other than add?
// Question 3: Should level order traversal be using queues or recursion?
// Question 4: what is "containsXXX"?  Is this in the textbook?  
//    What does "find the parent node to add a new node for building a BST" mean?
// Assumption: rather than recAdd always setting its node to the recursive call
//   then returning it, is the point to stop at the parent and add a new child,
//    instead of arriving at the child and returning it to the parent?
...
public class BinarySearchTree<T> implements BSTInterface<T> {
	...
	protected void preOrder(BSTNode<T> node, ArrayList<T> q)
	...
	protected void inOrder(BSTNode<T> node, ArrayList<T> q)
	...
	protected void postOrder(BSTNode<T> node, ArrayList<T> q)
